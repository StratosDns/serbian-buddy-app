...
const phoneticMap: [string, string][] = [
  ["omiljena", "omilyehhna"],
  ["tvoja", "tvawyah"], ["Tvoja", "Tvawyah"], ["TVOJA", "TVAWYAH"],
  ...
  ["lju", "llou"], ["Lju", "Llou"], ["LJU", "LLOU"],
  ["lj", "lyuh"], ["Lj", "Lyuh"], ["LJ", "LYUH"],
  ["nj", "ny"],   ["Nj", "Ny"],   ["NJ", "NY"],
  ["dž", "j"],    ["Dž", "J"],    ["DŽ", "J"],
  ["se", "seh"], ["SE", "SEH"], ["Se", "Seh"],
  ["la","lah"],   ["La","Lah"],
  ["đe","djeh"],  ["Đe", "Djeh"], ["ĐE", "DZEH"],
  ["crn", "tsern"], ["Crn", "Tsern"], ["CRN", "TSERN"],
  ["beo", "behoh"], ["Beo", "Behoh"], ["BEO", "BEHOH"],
  ["oja", "oyah"], ["Oja", "Oyah"], ["OJA", "OYAH"],
  ["ja", "yah"], ["Ja", "Yah"], ["JA", "YAH"],
  ["č", "ch"],    ["Č", "Ch"],
  ["ć", "ch"],    ["Ć", "Ch"],
  ["š", "sh"],    ["Š", "Sh"],
  ["ž", "zh"],    ["Ž", "Zh"],
